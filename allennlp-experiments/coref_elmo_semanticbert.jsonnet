// Elmo embeddings + Standard QALM embeddings for Coref
{
  "dataset_reader": {
    "type": "coref",
    "token_indexers": {
      ...
      "token_embedders": {
        ...
        "elmo": {
         ...
         "semanticbert": {
                ...
                "pretrained_model": "/path/to/models/outputs-semanticbert-probe-c2q-interaction-V3-all-1e-4-1e-4-64/pytorch_model.bin",
