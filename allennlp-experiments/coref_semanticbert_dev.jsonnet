// BERT embeddings + Standard QALM embeddings for Coref on the small data setting
{
  "dataset_reader": {
    "type": "coref",
    "token_indexers": {
  ...
  "train_data_path": "/path/to/data/Coref/dev.english.v4_gold_conll",
  "validation_data_path": "/path/to/data/Coref/test.english.v4_gold_conll",
