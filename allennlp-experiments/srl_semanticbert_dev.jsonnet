// BERT embeddings + Standard QALM embedding for SRL on the small data setting
{
    "dataset_reader": {
        "type": "srl",
        "token_indexers": {
    ...
    "train_data_path": "/path/to/data/conll-formatted-ontonotes-5.0/data/development",
    "validation_data_path": "/path/to/data/conll-formatted-ontonotes-5.0/data/test",
