...
# Flair embeddings + Standard QALM embeddings for SRL on the small data setting
...
trainer.train('/path/to/data/NER/ner-flair-semanticbert-dev',
              max_epochs=150)
