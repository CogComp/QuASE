...
from pytorch_pretrained_bert.modeling import (CONFIG_NAME, WEIGHTS_NAME,
                                              BertConfig)
from apply_models import BertForSRL
...
class InputExample(object):
    ...
    def __init__(self, guid, text, predicate=None, label=None):
        """Constructs a InputExample.

        Args:
            guid: Unique id for the example.
            text: string. The untokenized text of the sequence.
            predicate: the predicate indicator for the examples.
...
class InputFeatures(object):
    ...
    def __init__(self, input_ids, predicate_ids, input_mask, segment_ids, label_id):
    ...
    for line in fin.readlines():
        ...
        for tag in new_tags:
            if tag not in label_list:
                label_list.append('B-' + tag[2:])
                label_list.append('I-' + tag[2:])
        data.append((sentence, predicate, new_tags))
    print(label_list)
...
class SrlProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        ...
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "conll05.train.txt")), "train")

    def get_dev_examples(self, data_dir):
        """See base class."""
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "conll05.devel.txt")), "dev")

    def get_test_examples(self, data_dir):
        """See base class."""
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "conll05.test.wsj.txt")), "test")

    def get_labels(self):
        return ['O', 'B-A1', 'I-A1', 'B-A0', 'I-A0', 'B-AM-LOC', 'I-AM-LOC', 'B-AM-MNR', 'I-AM-MNR', 'B-A2', 'I-A2',
                'B-A3', 'I-A3', 'B-AM-TMP', 'I-AM-TMP', 'B-A4', 'I-A4', 'B-AM-NEG', 'I-AM-NEG', 'B-AM-MOD', 'I-AM-MOD',
                'B-R-A0', 'I-R-A0', 'B-AM-DIS', 'I-AM-DIS', 'B-AM-EXT', 'I-AM-EXT', 'B-AM-ADV', 'I-AM-ADV', 'B-AM-PNC',
                'I-AM-PNC', 'B-R-A1', 'I-R-A1', 'B-C-A1', 'I-C-A1', 'B-R-AM-TMP', 'I-R-AM-TMP', 'B-C-V', 'I-C-V',
                'B-AM-DIR', 'I-AM-DIR', 'B-R-A2', 'I-R-A2', 'B-AM-PRD', 'I-AM-PRD', 'B-R-AM-PNC', 'I-R-AM-PNC',
                'B-C-AM-MNR', 'I-C-AM-MNR', 'B-AM-CAU', 'I-AM-CAU', 'B-R-A3', 'I-R-A3', 'B-R-AM-MNR', 'I-R-AM-MNR',
                'B-C-A4', 'I-C-A4', 'B-R-AM-LOC', 'I-R-AM-LOC', 'B-C-A0', 'I-C-A0', 'B-C-A2', 'I-C-A2', 'B-R-AM-EXT',
                'I-R-AM-EXT', 'B-A5', 'I-A5', 'B-C-AM-LOC', 'I-C-AM-LOC', 'B-C-A3', 'I-C-A3', 'B-R-AM-CAU',
                'I-R-AM-CAU', 'B-R-A4', 'I-R-A4', 'B-C-AM-ADV', 'I-C-AM-ADV', 'B-R-AM-ADV', 'I-R-AM-ADV', 'B-AM-REC',
                'I-AM-REC', 'B-AM-TM', 'I-AM-TM', 'B-AM', 'I-AM', 'B-C-A5', 'I-C-A5', 'B-C-AM-TMP', 'I-C-AM-TMP',
                'B-AA', 'I-AA', 'B-R-AA', 'I-R-AA', 'B-C-AM-EXT', 'I-C-AM-EXT', 'B-C-AM-NEG', 'I-C-AM-NEG',
                'B-C-AM-DIS', 'I-C-AM-DIS', 'B-C-AM-CAU', 'I-C-AM-CAU', 'B-R-AM-DIR', 'I-R-AM-DIR', 'B-C-AM-DIR',
                'I-C-AM-DIR', 'B-C-AM-PNC', 'I-C-AM-PNC', 'X', '[CLS]', '[SEP]']

    def _create_examples(self, lines, set_type):
        examples = []
        for i, (sentence, predicate, label) in enumerate(lines):
            guid = "%s-%s" % (set_type, i)
            text = ' '.join(sentence)
            label = label
            examples.append(InputExample(guid=guid, text=text, predicate=predicate, label=label))
        return examples
...
def convert_examples_to_features(examples, label_list, max_seq_length, tokenizer):
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        predicatelist = example.predicate
        tokens = []
        labels = []
        predicates = []
        ...
        if len(tokens) >= max_seq_length - 1:
            ...
            predicates = predicates[0: (max_seq_length - 2)]
        ...
        for i, token in enumerate(tokens):
            ...
            predicate_ids.append(predicates[i])
            segment_ids.append(0)
...
def write_predictions(examples, y_true, y_pred, output_file):
    ...
    for index in range(len(examples)):
        ...
        gold_ner = y_true[index]
        pred_ner = y_pred[index]
        fout.write(text + "\n")
        fout.write(" ".join(gold_ner) + "\n")
        fout.write(" ".join(pred_ner) + "\n")
    fout.close()
...
def main():
    ...
    model = BertForSRL.from_pretrained(args.bert_model, cache_dir=cache_dir, num_labels=num_labels)
    if args.pretrain:
    ...
    if args.do_train:
        ...
        model = BertForSRL.from_pretrained(args.bert_model, state_dict=model_state_dict, num_labels=num_labels)
