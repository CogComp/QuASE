...
from modeling import ConditionalSemanticBertForQuestionAnswering, BertModel
...
def main():
    ...
    # Prepare model
    model = ConditionalSemanticBertForQuestionAnswering.from_pretrained(args.bert_model,
                cache_dir=PYTORCH_PRETRAINED_BERT_CACHE / 'distributed_{}'.format(args.local_rank))

    model.QABert = BertModel.from_pretrained(args.bert_model,
                                             cache_dir=PYTORCH_PRETRAINED_BERT_CACHE / 'distributed_{}'.format(args.local_rank))
    if args.pretrain:
        ...
        print('QABert', model_state_dict['QABert.encoder.layer.4.attention.self.value.weight'])
    ...
    model = ConditionalSemanticBertForQuestionAnswering.from_pretrained(args.bert_model, state_dict=model_state_dict)
    model.to(device)
