...
from pytorch_pretrained_bert.modeling import (CONFIG_NAME, WEIGHTS_NAME,
                                              BertConfig)
from apply_models import BertForSDP
...
def main():
    ...
    model = BertForSDP.from_pretrained(args.bert_model, cache_dir=cache_dir, num_labels=num_labels)
    if args.pretrain:
    ...
    if args.do_train:
        ...
        model = BertForSDP.from_pretrained(args.bert_model, state_dict=model_state_dict, num_labels=num_labels)
