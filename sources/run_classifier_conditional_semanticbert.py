...
from modeling import ConditionalSemanticBertForSequenceClassification, BertModel
...
class WnliProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        """See base class."""
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "train.sample.10%.tsv")), "train")
...
def main():
    ...
    # Prepare model
    model = ConditionalSemanticBertForSequenceClassification.from_pretrained(args.bert_model,
    ...
    model = ConditionalSemanticBertForSequenceClassification.from_pretrained(args.bert_model, state_dict=model_state_dict, num_labels=num_labels)
    model.to(device)
