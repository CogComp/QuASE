...
from pytorch_pretrained_bert.modeling import (CONFIG_NAME, WEIGHTS_NAME,
                                              BertConfig)
from modeling import ConditionalSemanticBertForTokenClassification, BertModel
...
def main():
    ...
    model = ConditionalSemanticBertForTokenClassification.from_pretrained(args.bert_model, cache_dir=cache_dir, num_labels=num_labels)
    ...
    if args.do_train:
        ...
        model = ConditionalSemanticBertForTokenClassification.from_pretrained(args.bert_model, state_dict=model_state_dict, num_labels=num_labels)
