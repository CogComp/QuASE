...
from apply_models import SemanticBertForAMRProbing
...
def main():
    ...
    model = SemanticBertForAMRProbing.from_pretrained(args.bert_model, cache_dir=cache_dir, num_labels=num_labels)
    if args.pretrain:
    ...
    if args.do_train:
        ...
        model = SemanticBertForAMRProbing.from_pretrained(args.bert_model, state_dict=model_state_dict, num_labels=num_labels)
